...
##In the R script, I was able to plot CP, but it throws an error in R Markdown
...
##The following lines function fine in an R-script, but when copied to the R Markdown file 
##they throw an error that stops Knit process
